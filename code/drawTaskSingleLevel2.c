...
//	Number of asteroids to be destroyed in this level
	...
	asteroid_5.spawn_position.x = 330;
	asteroid_5.spawn_position.y = 40;
	asteroid_5.position.x = 330;
	...
	asteroid_6.spawn_position.y = 250;
	asteroid_6.position.x = 80;
	asteroid_6.position.y = 250;
	...
	asteroid_7.spawn_position.y = 250;
	asteroid_7.position.x = 280;
	asteroid_7.position.y = 250;
